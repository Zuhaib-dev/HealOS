    ...
    <div className="flex min-h-screen w-full flex-col lg:flex-row">
      ...
      <div className="relative hidden w-full flex-col lg:flex lg:w-1/2 overflow-hidden bg-emerald-950">
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between p-12 lg:p-16">
          <Link href="/" aria-label="HealOS Home" title="HealOS Home" className="inline-flex items-center gap-2 text-emerald-50 w-max">
            <HealOSLogo size={32} />
          </Link>
      ...
      <div className="relative flex w-full flex-1 flex-col justify-center bg-background px-5 py-12 sm:px-8 lg:w-1/2 lg:px-20 xl:px-24">
        ...
        <div className="absolute top-6 left-6 lg:hidden flex items-center gap-3">
          <Link href="/" aria-label="Back to home" title="Back to home" className="inline-flex items-center gap-1.5 text-muted-foreground hover:text-foreground transition-colors">
            <ArrowLeft className="h-4 w-4" />
          </Link>
          <Link href="/" aria-label="HealOS Home" title="HealOS Home" className="inline-flex items-center gap-2">
            <HealOSLogo size={28} />
          </Link>
        </div>
