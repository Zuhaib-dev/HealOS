    ...
    <div className="bg-background text-foreground min-h-screen pb-24 md:pb-0">
      ...
      <div className="flex">
        ...
        >
          ...
          <div className={`mt-auto rounded-xl border border-border/70 bg-card/60 shadow-sm transition-all overflow-hidden ${isCollapsed ? "p-2 py-3 flex flex-col items-center" : "p-4"}`}>
            {isCollapsed ? (
